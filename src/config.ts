...
export const siteConfig: SiteConfig = {
	title: "Mizuki",
	subtitle: "shotawebsite",
	siteURL: "https://mizuki.mysqil.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-02-09", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "594774689", // 在此处设置你的Bilibili用户ID (vmid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/shotamiao",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/594774689",
					external: true,
